async function carregarJogadores() {
  const url =
    "https://docs.google.com/spreadsheets/d/e/2PACX-1vSpYqMuzSsXqjixKp0a4eTsuoaqtQMwfnqXsXb8w5z3gIrUt4yO5oQPTBgP8BnSwQ-8in26XBEjiWVL/pub?gid=557483612&single=true&output=csv";
  ...
  am5.ready(function () {
    ...
    series1.bullets.push(function () {
      ...
      container.children.push(
        am5.Circle.new(root1, { radius: 34 }, circleTemplate1)
      );
    ...
    series2.bullets.push(function () {
      ...
      container.children.push(
        am5.Circle.new(root2, { radius: 34 }, am5.Template.new({}))
      );
    ...
    const chart3 = root3.container.children.push(
